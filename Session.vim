...
argglobal
%argdel
edit Codeforces/CrossTheCharges.cpp
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 31 + 40) / 80)
exe 'vert 2resize ' . ((&columns * 48 + 40) / 80)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
exe 'vert 2resize ' . ((&columns * 48 + 40) / 80)
tabnext 1
badd +0 Codeforces/CrossTheCharges.cpp
